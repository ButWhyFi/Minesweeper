 ...
 *          Located in the displayImage method under the GridSpace constructor.
 */
...
public class GridSpace extends GridPane {
  ...
  /*
   * The coordinates of surrounding squares and their relativity to the center square (the square
   * object that it belongs to). It starts in the top left and goes clockwise.
   */
   ...
   * 
   * CHANGE THE FILE DIRECTOY IN THIS METHOD!
   */
  ...
  public class GridSquares extends Pane {
    ...
    /*
     * Represents squares adjacent to square object it belongs to. The array starts in the top left
     * and goes clockwise. A boolean is assigned based on whether or not the square exists.
     */
