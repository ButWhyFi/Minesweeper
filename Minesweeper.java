 ...
 * @Version: August 2022
 * 
 *           Minesweeper class sets the stage of the main window and contains the difficulty
...
public class Minesweeper extends Application {
  ...
  /*
   * Recreates the stage, resets grid variables, and sets the properties of both the stage and the
   * grid.
   * 
  ...
  /*
   * Sets the values of each corresponding variable
   */
